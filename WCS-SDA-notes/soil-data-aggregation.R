...
## moving all of this into 'gNATSGO-data-prep.R'
...
# 
# levelplot(rs, margin = FALSE, main = '1:1 H2O pH 0-5cm', scales = list(draw = FALSE), maxpixels = 1e6, col.regions = viridis, names.attr = c('SSURGO/STATSGO (gNATSGO at 300m)', 'SSURGO/STATSGO (ISSR-800 at 800m)'))
# 
