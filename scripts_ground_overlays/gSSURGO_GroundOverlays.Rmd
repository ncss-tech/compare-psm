...
```{r}
subtile.offset.long <- 36  # minutes offset from lrc, longitude
subtile.offset.lat <- 18   # minutes offset from lrc, latitude
subtile.size <- 5  # tile size, minutes in long and lat
```
