...
```{r}
voi.n <- 4
voi <- voi.list[voi.n]   # variable of interest, SoilGrids name
depth <- "30-60cm" # "0-5", "5-15", "15-30", "30-60", "60-100", "100-200"
...
Compute the upper-left corner and the bounding box:
