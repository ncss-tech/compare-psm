...
Set the property and quantile:

```{r}
voi.polaris <- "clay"   # variable of interest, POLARIS name
quantile.polaris <- "p50"  # p5, p50, mean, p95
```
...
Set the depth, and build a full layer name with the property, depth, and quantile:

```{r}
depth.polaris <- "30_60" # "0-5", "5-15", "15-30", "30-60", "60-100", "100-200"
