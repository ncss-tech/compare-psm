...
Here are the primary soil properties, there are also soil hydrological parameters we do not process.
...
```{r}
voi.polaris <- "bd"   # variable of interest, POLARIS name
depth.polaris <- "60_100" # "0-5", "5-15", "15-30", "30-60", "60-100", "100-200"
