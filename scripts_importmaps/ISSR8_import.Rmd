...
3. [Select an Area of Interest](#aoi), a $1 \times 1^\circ$ tile.
...
Note ISSR-800 only has SOM stocks and average bulk density, not by depth slice.
...
Select a depth slice. Note only 0-5 and 30-60 can be directly compared to GSM-standard PSM maps.
