...
* [gSSURGO](https://nrcs.app.box.com/v/soils) -- as polygon maps than can be rasterized
* [Global Soil Map v0.5](https://new.cloudvault.usda.gov/index.php/s/AdiZdePpT9aJ6oZ) -- limited access, US Government site
Also [here](https://edcftp.cr.usgs.gov/project/soil/GlobalSoilMap/)     
...
* [LandGIS](https://gitlab.com/openlandmap/global-layers)
...
The overlay can be displayed along with [SoilWeb Apps](https://casoilresource.lawr.ucdavis.edu/soilweb-apps/), including SoilWeb Earth which displays SSURGO (detailed) or NATSGO (generalized) soil map units in Google Earth. 

There is one R Markdown file for each product, in subdirectory `scripts_ground_overlays`.
