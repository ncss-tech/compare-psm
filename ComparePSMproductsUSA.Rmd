...
To compare products, adjust each of these to the area of interest (AOI), property of interest, and the depth slice of interest, and import the product. To compare uncertainties also specify the quantile of interest, for those products that provide it. These should be adjusted in the YAML. Also, the script `Import_all.R` can be used to import one or more products, setting the parameters there.
