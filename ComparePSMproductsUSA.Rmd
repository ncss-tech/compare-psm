...
Two products provide prediction quantiles at 5, 50 and 95%, as well as the mean: SoilGrids250 and POLARIS. These can be compared with script `./scripts_compare/Compare_regional_uncertainty.Rmd`. These quantiles must have been previously imported.
