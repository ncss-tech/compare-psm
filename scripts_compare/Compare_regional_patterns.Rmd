...
if (exists("psu.sf.v")) {
  ...
  terra::plot(regions.sg.psu$map1["rih"], main = "Inhomogeneity -- SPCG vs. SG2")
  terra::plot(regions.sg.psu$map2["rih"], main = "Incompleteness -- SPCG vs. SG2")
}
```
...
if (exists("regions.gnatsgo.psu")) {
  vmeasure.compare[i <- i+1,] <- c("SG2 va. SPCG100", 
