...
5. Generated figures will be in directory `./figs/compare_maps/`. These will be specific to the AOI, property and depth slice. So to save them from over-writing by other runs, move them to another directory.
...
```{r vmaps.gsm.sg, fig.width=5, fig.height=7}
...
```{r vmaps.gsm.psu, fig.width=5, fig.height=7}
...
```{r vmaps.gsm.polaris, fig.width=5, fig.height=7}
...
ylims <- c(0, max(v.gsm$gamma, v.sg$gamma,  
