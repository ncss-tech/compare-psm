...
(dest.dir.sg <-  file.path(base.dir.sg,
                          ...
                          voi))
## Q0.05
(file.sg <- paste0(dest.dir.sg, "/Q0.05/", depth, "cm/", voi_layer_05, '_4326.tif'))
...
## Q0.5
(file.sg <- paste0(dest.dir.sg, "/Q0.5/", depth, "/cm", voi_layer_50, '_4326.tif'))
if (file.exists(file.sg)) {
...
## Q0.95
(file.sg <- paste0(dest.dir.sg, "/Q0.95/", depth, "/cm", voi_layer_95, '_4326.tif'))
if (file.exists(file.sg)) {
